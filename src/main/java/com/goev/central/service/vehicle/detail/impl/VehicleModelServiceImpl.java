...
public class VehicleModelServiceImpl implements VehicleModelService {
    ...
    private static VehicleModelDao getVehicleModelDao(VehicleModelDto vehicleModelDto) {
    ...
    public PaginatedResponseDto<VehicleModelDto> getModels() {
        PaginatedResponseDto<VehicleModelDto> result = PaginatedResponseDto.<VehicleModelDto>builder().elements(new ArrayList<>()).build();
        ...
        for (VehicleModelDao vehicleModelDao : vehicleModelDaos) {
            ...
            result.getElements().add(getVehicleModelDto(vehicleModelDao, manufacturerDao));
        }
        return result;
    }
    ...
    public VehicleModelDto createModel(VehicleModelDto vehicleModelDto) {
        VehicleModelDao vehicleModelDao = getVehicleModelDao(vehicleModelDto);
        ...
        return getVehicleModelDto(vehicleModelDao, manufacturerDao);
    }

    private VehicleModelDto getVehicleModelDto(VehicleModelDao vehicleModelDao, VehicleManufacturerDao manufacturerDao) {
